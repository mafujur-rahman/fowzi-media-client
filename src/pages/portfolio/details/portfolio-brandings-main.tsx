...
import port_d_4 from '@/assets/img/inner-project/portfolio-details/brandings/port-d-4.png';
import port_d_5 from '@/assets/img/inner-project/portfolio-details/brandings/port-d-5.png';
...
const port_images = [
    ...
    { src: port_d_5, link: "/branding/radiant-future" }
  ];
  
  const PortfolioBrandingsMain = () => {
                      ...
                      <div className="project-details-1-right-wrap">
                        <div className="project-details-1-right p-relative">
                          <div className="project-details-1-title-box">
                            <span className="project-details-1-subtitle" style={{fontFamily: 'Glacial Indifference'}}><i>01</i>Design Studio</span>
                            <h4 className="project-details-1-title">Brandings</h4>
                            <p style={{fontFamily: 'Glacial Indifference'}}>We provide digital experience services to startups and
                          ...
                          <div className="project-details-1-info-wrap">
                            <div className="project-details-1-info">
                              ...
                              <h4 style={{fontFamily: 'Glacial Indifference'}}>Design & Prototyping</h4>
                            </div>
                            <div className="project-details-1-info">
                        ...
                        <div className="project-details-1-navigation d-flex justify-content-between align-items-center">
                          <a className="project-details-1-prev" href="portfolio-photography">
                          ...
                          <a className="project-details-1-next" href="/portfolio-development">
  ...
  export default PortfolioBrandingsMain;