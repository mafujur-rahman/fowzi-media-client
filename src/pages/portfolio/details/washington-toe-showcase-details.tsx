...
import WashingtonToeShowcaseArea from "@/components/portfolio/details/washington-toe-showcase-area";


const WashingtonToeShowcaseMain = () => {
...
export default WashingtonToeShowcaseMain;
