                      ...
                      <div className="project-details-1-right-wrap">
                        <div className="project-details-1-right p-relative">
                          <div className="project-details-1-title-box">
                            <span className="project-details-1-subtitle" style={{fontFamily: 'Glacial Indifference'}}><i>02</i>Development Studio</span>
                            <h4 className="project-details-1-title">Development</h4>
                        ...
                        <div className="project-details-1-navigation d-flex justify-content-between align-items-center">
                          <a className="project-details-1-prev" href="portfolio-brandings">
                          ...
                          <a className="project-details-1-next" href="/portfolio-videography">
