...
// images
import port_d_1 from '@/assets/img/latest-projects/awad-details-mockup/1.jpg';
import port_d_2 from '@/assets/img/latest-projects/awad-details-mockup/2.jpg';
import port_d_3 from '@/assets/img/latest-projects/awad-details-mockup/3.jpg';
import port_d_4 from '@/assets/img/latest-projects/awad-details-mockup/4.jpg';
import FooterFour from "@/layouts/footers/footer-four";
import HeaderFour from "@/layouts/headers/header-four";

const port_images = [port_d_1, port_d_2, port_d_3, port_d_4];

const AwadDetailsMain = () => {
                        ...
                        <div className="project-details-1-right-wrap">
                           <div className="project-details-1-right p-relative">
                              <div className="project-details-1-title-box">
                                 <span className="project-details-1-subtitle"><i>03</i>Branding & Ui/Ux</span>
                                 <h4 className="project-details-1-title">Awad For Puntland</h4>
                           ...
                           <div className="project-details-1-navigation d-flex justify-content-between align-items-center">
                              <a className="project-details-1-prev" href="/jannah-fitwear-details">
                              ...
                              <a className="project-details-1-next" href="/hudda-details">
                                 <span>Next</span>
...
export default AwadDetailsMain;
