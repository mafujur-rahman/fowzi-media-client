...
// images
import port_d_1 from '@/assets/img/portfolio/fowzi image/web development/somali youth/web-1.jpg';
import port_d_2 from '@/assets/img/portfolio/fowzi image/web development/somali youth/tab-1.jpg';
import port_d_3 from '@/assets/img/portfolio/fowzi image/web development/somali youth/uiux.jpg';
...
const port_images = [
                      ...
                      <div className="project-details-1-right-wrap">
                        <div className="project-details-1-right p-relative">
                          <div className="project-details-1-title-box">
                            ...
                            <h4 className="project-details-1-title">Somali Youth</h4>
                        ...
                        <div className="project-details-1-navigation d-flex justify-content-between align-items-center">
                          <a className="project-details-1-prev" href="/infinity-care">
                          ...
                          <a className="project-details-1-next" href="/washington-toe">
  ...
  export default SomaliYouthMain;