...
import details_thumb_1 from '@/assets/img/home-12/portfolio/branding/awad/branding-2.jpg';
import details_thumb_2 from '@/assets/img/home-12/portfolio/branding/awad/branding-3.jpg';
import details_thumb_3 from '@/assets/img/home-12/portfolio/branding/awad/branding-4.jpg';

export default function AwadShowcaseArea() {
  const scrollTo = () => {
    ...
    <>
      ...
      <div className="tp-showcase-details-area">
        <div
          ...
          style={{
            backgroundImage: "url(/assets/img/home-12/portfolio/branding/awad/branding-1.jpg)",
            position: "relative",
          }}
        >
          {/* Black overlay */}
