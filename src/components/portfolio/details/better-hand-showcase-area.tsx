...
import details_thumb_1 from '@/assets/img/home-12/portfolio/better hand/branding-2.png';
import details_thumb_2 from '@/assets/img/home-12/portfolio/better hand/branding-3.png';
import details_thumb_3 from '@/assets/img/home-12/portfolio/better hand/branding-4.png';

export default function BetterHandShowcaseArea() {
  const scrollTo = () => {
    ...
    <>
     {/* details area */}
      <div className="tp-showcase-details-area">
         <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative" style={{backgroundImage: "url(/assets/img/home-12/portfolio/better%20hand/branding-1.png)"}}>
              ...
              <div className="row">
                <div className="col-12">
                    <div className="tp-showcase-details-content text-center">
                      ...
                      <h4 className="port-showcase-slider-title tp-char-animation">Better Hand</h4>
                    </div>
                </div>
              </div>
          </div>
