...
import details_thumb_1 from '@/assets/img/home-12/portfolio/web-development/somali-youth-mind/web-development-2.jpg';
import details_thumb_2 from '@/assets/img/home-12/portfolio/web-development/somali-youth-mind/web-development-3.jpg';
import details_thumb_3 from '@/assets/img/home-12/portfolio/web-development/somali-youth-mind/web-development 4.jpg';

export default function SomaliYouthShowcaseArea() {
  const scrollTo = () => {
  ...
  return (
    <>
      ...
      <div className="tp-showcase-details-area">
        <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative" style={{ backgroundImage: "url(/assets/img/home-12/portfolio/web-development/somali-youth-mind/web-development1.jpg)" }}>
