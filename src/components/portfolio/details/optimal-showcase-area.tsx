...
import details_thumb_1 from '@/assets/img/home-12/portfolio/optimal/branding2-.png';
import details_thumb_2 from '@/assets/img/home-12/portfolio/optimal/branding-3.png';
import details_thumb_3 from '@/assets/img/home-12/portfolio/optimal/branding-4.png';

export default function OptimalShowcaseArea() {
  const scrollTo = () => {
    ...
    <>
     {/* details area */}
      <div className="tp-showcase-details-area">
         <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative" style={{backgroundImage: "url(/assets/img/home-12/portfolio/optimal/branding-1.png)"}}>
              ...
              <div className="row">
                <div className="col-12">
                    <div className="tp-showcase-details-content text-center">
                      ...
                      <h4 className="port-showcase-slider-title tp-char-animation">Optimal Home Healthcare</h4>
                    </div>
                </div>
              </div>
          </div>
