...
export default function ShamilShowcaseArea() {
    const scrollTo = () => {
                ...
                <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative">
                    ...
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <iframe
                                src="https://player.vimeo.com/video/946386055?background=1&autoplay=1&loop=1&byline=0&title=0&muted=1"
                                frameBorder="0"
                        ...
                        <div className="row">
                            <div className="col-12">
                                <div className="tp-showcase-details-content text-center">
                                    ...
                                    <h4 className="port-showcase-slider-title tp-char-animation">Shamil Mirza Testimonial</h4>
                                </div>
                            </div>
                        </div>
                    </div>
