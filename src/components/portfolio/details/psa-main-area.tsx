...
// images
import port_d_1 from '@/assets/img/portfolio/fowzi image/dont-wait-until-1.jpg';
import port_d_2 from '@/assets/img/portfolio/fowzi image/dont-wait-until-2.jpg';
import port_d_3 from '@/assets/img/portfolio/fowzi image/dont-wait-until-3.jpg';
import HeaderFour from "@/layouts/headers/header-four";
import FooterFour from "@/layouts/footers/footer-four";

const port_images = [
    { type: 'video', src: 'https://vimeo.com/1058793031?share=copy' },
                          ...
                          <div key={i} className="project-details-1-thumb mb-10">
                            {item.type === 'video' ? (
                              <div className="video-container" style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
                                <iframe 
                                  src="https://player.vimeo.com/video/1058793031?autoplay=1&loop=1&title=0&byline=0&portrait=0" 
                                  style={{
                                    position: 'absolute',
                                    top: 0,
                                    left: 0,
                      ...
                      <div className="project-details-1-right-wrap">
                        <div className="project-details-1-right p-relative">
                          <div className="project-details-1-title-box">
                            ...
                            <h4 className="project-details-1-title">PSA Film</h4>
                        ...
                        <div className="project-details-1-navigation d-flex justify-content-between align-items-center">
                          <a className="project-details-1-prev" href="/child-safety-main">
                          ...
                          <a className="project-details-1-next" href="/sbd-main">
