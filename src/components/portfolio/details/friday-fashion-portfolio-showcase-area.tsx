    ...
    <>
     {/* details area */}
      <div className="tp-showcase-details-area">
         <div className="tp-showcase-details-bg d-flex align-items-center justify-content-center include-bg p-relative" style={{ backgroundImage: `url("/assets/img/home-12/portfolio/friday%20fashion/branding-1.png")` }}>
              ...
              <div className="row">
                <div className="col-12">
                    <div className="tp-showcase-details-content text-center">
                      ...
                      <h4 className="port-showcase-slider-title tp-char-animation">Friday Fashion</h4>
                    </div>
                </div>
              </div>
          </div>
