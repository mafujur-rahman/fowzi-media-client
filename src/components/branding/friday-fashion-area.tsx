  ...
  return (
    <div className="container pt-150">
      ...
      <div className="my-5">
        ...
        <p><a href="https://fonts.adobe.com/fonts/retiro" style={{ fontFamily: 'Glacial Indifference' }}>https://fonts.adobe.com/fonts/retiro</a></p>
        <h1 className="display-1 fw-bold  text-center">Retiro</h1>
...
export default FridayFashionArea;
