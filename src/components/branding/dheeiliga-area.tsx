    ...
    <div className="container pt-150">
      ...
      <div className="my-5">
        ...
        <div className="row justify-content-center gap-3">
          <div className="col-6 col-md-auto p-5 text-white rounded " style={{ backgroundColor: "#d7dbdc" }}>#d7dbdc</div>
          <div className="col-6 col-md-auto p-5 text-white rounded " style={{ backgroundColor: "#d3d3d3" }}>#d3d3d3</div>
