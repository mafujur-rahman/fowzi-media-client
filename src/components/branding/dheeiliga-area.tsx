...
const DheeiligaArea = () => {
  ...
  return (
    <div className="container pt-150">
      <div className="">
        <h2 ref={textRef} className="fw-bold display-1" style={{ fontFamily: 'Glacial Indifference', fontWeight: 'bold' }}>Dheelliga Hoggaamineed</h2>
      </div>

      {/* Banner */}
      <div className="position-relative overflow-hidden" style={{ height: "500px" }}>
        <Image
          src="/assets/img/branding/dheelliga/BOOK-DESIGN.jpg"
          alt="about-img-1"
      ...
      <div className="my-5">
        ...
        <div className="d-flex justify-content-center gap-3">
          <div className="p-5 text-white rounded " style={{ backgroundColor: "#d7dbdc" }}>#d7dbdc</div>
          <div className="p-5 text-white rounded " style={{ backgroundColor: "#d3d3d3" }}>#d3d3d3</div>
          <div className="p-5 text-dark rounded " style={{ backgroundColor: "#0C0C0C" }}>#0C0C0C</div>
      ...
      <div className="row g-3">
        ...
        <div className="col-md-6 d-flex flex-column">
          <div className="flex-grow-1">
            <Image
              src="/assets/img/branding/dheelliga/BOOK-DESIGN-2.jpg"
              width={600}
              height={450}
        ...
        <div className="col-md-6 d-flex flex-column">
          <div className="flex-grow-1">
            <Image
              src="/assets/img/branding/dheelliga/BOOK-DESIGN-3.jpg"
              width={600}
              height={450}
              className="img-fluid rounded-4 w-100 h-100 object-fit-cover"
